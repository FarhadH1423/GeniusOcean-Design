(function ($) {
  ...
  $(".case-study-single").each(function () {
    $(this).hover(function () {
      $(this)
        .parents(".case-study-box")
        .find(".case-study-single.active")
        .removeClass("active");
  ...
  $(".theme-color-switch .color-list li a:not(.primary)").each(function () {
    $(this).on("click", function () {
      ...
      //hero banner
      var hero_banner =
        "assets/images/banner/hero-banner-" + class_name + ".jpg";
  ...
  $(".hm5-sidebar-navigation li a").each(function () {
    $(this).on("click", function (event) {
      ...
      $(this)
        .parents(".hm5-sidebar-navigation")
        .find("a.active")
        .removeClass("active");
      $(this).addClass("active");
